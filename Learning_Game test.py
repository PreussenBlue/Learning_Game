...
while running:
    ...
    sand = button(ag_tekst,10,80,60,30,green,red,15,86,sand,op)
    
    sand = button(al_tekst,110,80,60,30,green,red,115,86,sand,op)

    sand = button(ba_tekst,210,80,60,30,green,red,215,86,sand,op)

    sand = button(ca_tekst,310,80,60,30,green,red,315,86,sand,op)

    sand = button(k3_tekst,410,80,60,30,green,red,415,86,sand,op)

    sand = button(ki_tekst,510,80,60,30,green,red,515,86,sand,op)

    sand = button(cu_tekst,610,80,60,30,green,red,615,86,sand,op)
    
    sand = button(na_tekst,710,80,60,30,green,red,715,86,sand,op)


    

    #laver knapper til række 2
    sand = button(ag_tekst,10,230,60,30,green,red,15,236,sand,op)
    
    sand = button(al_tekst,110,230,60,30,green,red,115,236,sand,op)

    sand = button(ba_tekst,210,230,60,30,green,red,215,236,sand,op)

    sand = button(ca_tekst,310,230,60,30,green,red,315,236,sand,op)

    sand = button(k3_tekst,410,230,60,30,green,red,415,236,sand,op)

    sand = button(ki_tekst,510,230,60,30,green,red,515,236,sand,op)

    sand = button(cu_tekst,610,230,60,30,green,red,615,236,sand,op)

    sand = button(na_tekst,710,230,60,30,green,red,715,236,sand,op)
